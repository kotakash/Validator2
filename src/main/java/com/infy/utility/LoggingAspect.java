...
public class LoggingAspect {
	...
	@AfterThrowing(pointcut = "execution(* com.infy.dao.*DAOImpl.*(..))", throwing = "exception")
	...
	// DO NOT CHANGE METHOD SIGNATURE AND DELETE/COMMENT METHOD
	@AfterThrowing(pointcut = "execution(* com.infy.service.*ServiceImpl.*(..))", throwing = "exception")
